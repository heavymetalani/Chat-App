...
public class ChatProvider extends ContentProvider {
    ...
    public static class DbHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String query = "CREATE TABLE "+PEERS_TABLE+" ( "+PeerContract.ID+" INTEGER PRIMARY KEY, " + PeerContract.NAME+
                    " TEXT NOT NULL, "+PeerContract.LAST_TIME+" LONG NOT NULL, " + PeerContract.ADDRESS +
                    " TEXT NOT NULL);";
            db.execSQL(query);
            db.execSQL(" CREATE TABLE "+MESSAGES_TABLE+" ( "+MessageContract.ID+" INTEGER PRIMARY KEY, " +
                    MessageContract.MESSAGE_TEXT+" TEXT NOT NULL, "+MessageContract.SENDER+" TEXT NOT NULL, " +
    ...
    public String getType(Uri uri) {
        ...
        switch(uriMatcher.match(uri)){
            case MESSAGES_ALL_ROWS : return MESSAGE_CONTENT_PATH;
            case MESSAGES_SINGLE_ROW : return MESSAGE_CONTENT_PATH_ITEM;
            case PEERS_ALL_ROWS : return PEER_CONTENT_PATH;
            case PEERS_SINGLE_ROW : return PEER_CONTENT_PATH_ITEM;
        }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)) {
            case MESSAGES_ALL_ROWS:
                ...
                return Uri.parse("content://"+AUTHORITY+"/"+MESSAGE_CONTENT_PATH+"/"+res);

            case PEERS_ALL_ROWS:
                // TODO: Implement this to handle requests to insert a new peer.
                // Make sure to notify any observers
                long res2 = db.insert(PEERS_TABLE, null, values);
                if (res2<0){
                    throw new UnsupportedOperationException("Not yet implemented");
                }
                getContext().getContentResolver().notifyChange(uri,null);
                return Uri.parse("content://"+AUTHORITY+"/"+PEER_CONTENT_PATH+"/"+res2);
